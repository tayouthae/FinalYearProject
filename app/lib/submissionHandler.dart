            ...
            RaisedButton(
              ...
              onPressed: () async {
                ...
                data = StudentWallet.privateKey +
                    ...
                    _subController.text +
                    ":" +
                    hash.substring(0, 45); //!hash truncate
                setState(() {
                  visible = true;
                });

                var formData = FormData.fromMap({
                  'privateKey': StudentWallet.privateKey,
                  'courseAddress': _subController.text,
                  'fileHash': hash.substring(0, 45),
                });
                var response = await dio.post(url+":8080/test",
                    data: formData);
                print("response");
                print(response);
              },
